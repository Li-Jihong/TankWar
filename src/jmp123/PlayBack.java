 ...
 * <ul>
 * <li>可以调用PlayBack对象的 {@link #getHeader()} 方法获取 {@link Header} 对象；</li>
 * <li>可以调用PlayBack对象的 {@link #getID3Tag()} 方法获取 {@link ID3Tag} 对象；</li>
 * </ul>
...
public class PlayBack {
	 ...
	 *
	 * @param audio
	 *            指定的音频输出 {@link IAudio} 对象。若指定为 <b>null</b> 则只解码不播放输出。
